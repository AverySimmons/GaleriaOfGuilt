...
func _init() -> void:
	...
	upgrade_description = "Your blood effectiveness is increased by 40%, but you lose blood more rapidly."
...
func choose_upgrade() -> void:
	...
	GameData.player.bb_hitspd *= 1.4
	GameData.player.bb_spd *= 1.4
