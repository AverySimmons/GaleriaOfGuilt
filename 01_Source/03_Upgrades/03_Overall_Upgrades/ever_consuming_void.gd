...
func _init() -> void:
	...
	upgrade_description = "Your threshold to passively lose blood is reduced to zero as well as slightly more blood loss, but your blood gain increases significantly."
