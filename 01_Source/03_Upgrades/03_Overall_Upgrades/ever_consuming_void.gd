...
func _init() -> void:
	...
	upgrade_description = "Increase your blood gain by 70%, but your threshold to passively lose blood is reduced to zero."
...
func choose_upgrade() -> void:
	...
	GameData.player.bb_multiplier2 *= 1.7
	GameData.player.percentage_to_start_removing_blood_passively = 0
	GameData.player.passive_blood_loss_amount_at_max_blood += 2
